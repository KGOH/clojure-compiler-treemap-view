...
(defn get-loaded-classes
  "Return map of class-name -> {:bytecode-size n :field-count n :instruction-count n} for all captured classes.

   Field count and instruction count may be -1 if parsing failed for a class.
